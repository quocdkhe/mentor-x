...
namespace backend.Migrations
{
    ...
    [Migration("20260427051451_Add_Call_And_CallLog_Tables")]
    partial class Add_Call_And_CallLog_Tables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.AppointmentPayment", b =>
                {
                    ...
                    b.Property<DateTime?>("MentorPaidAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<DateTime?>("UserPaidAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.ToTable("appointment_payments", (string)null);
                });
            ...
            modelBuilder.Entity("backend.Models.Call", b =>
                {
                    ...
                    b.HasIndex(new[] { "AppointmentId" }, "idx_calls_appointment_id");

                    b.HasIndex(new[] { "InitiatorId" }, "idx_calls_initiator_id");

                    b.HasIndex(new[] { "RecipientId" }, "idx_calls_recipient_id");

                    b.HasIndex(new[] { "Status" }, "idx_calls_status");
            ...
            modelBuilder.Entity("backend.Models.CallLog", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("call_logs_pkey");

                    b.HasIndex(new[] { "CallId" }, "idx_call_logs_call_id");

                    b.HasIndex(new[] { "Timestamp" }, "idx_call_logs_timestamp");

                    b.HasIndex(new[] { "UserId" }, "idx_call_logs_user_id");
            ...
            modelBuilder.Entity("backend.Models.MentorReview", b =>
                {
                    ...
                    b.HasIndex(new[] { "MenteeId" }, "idx_mentor_reviews_mentee_id");

                    b.HasIndex(new[] { "MentorId" }, "idx_mentor_reviews_mentor_id");
            ...
            modelBuilder.Entity("mentor_review_upvotes", b =>
                {
                    b.Property<Guid>("mentor_review_id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("user_id")
                        .HasColumnType("uuid");

                    b.HasKey("mentor_review_id", "user_id");

                    b.HasIndex("user_id");

                    b.ToTable("mentor_review_upvotes", (string)null);
                });
            ...
            modelBuilder.Entity("backend.Models.AppointmentPayment", b =>
                {
                    b.HasOne("backend.Models.Appointment", "Appointment")
                        .WithOne("Payment")
                        .HasForeignKey("backend.Models.AppointmentPayment", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("mentor_review_upvotes", b =>
                {
                    b.HasOne("backend.Models.MentorReview", null)
                        .WithMany()
